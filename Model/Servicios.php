...
class Servicios extends Conectar {
  ...
  public function  Set_servicio_principal($id,$servicio){
    $array = Array("Tipo_id"=>$id,
                   "Tipo_nomb"=>$servicio);
  ...
  public function Set_servicios_secundario($id,$id_tipo,$nomb,$cost,$tiemp){
    $array = Array("Servi_id"=>$id,
                   "Servi_id_tip"=>$id_tipo,
                   "Servi_nomb"=>$nomb,
                   "Servi_cost"=>$cost,
                   "Servi_tiem"=>$tiemp);
  ...
  public function Get_service_by_id($id){
    $sql = 'SELECT Servi_cost,Servi_tiem
            FROM servicios_prestado 
            WHERE Servi_id = '.$id;
    $response = parent::consultas($sql);
    return $response;
